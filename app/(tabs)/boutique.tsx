...
const DEMO_JEWELRY: PartnerJewelry[] = [
  ...
  },
  {
    id: 3,
    brandId: 1,
    name: "Boucles d'oreilles Fleur de Lotus",
    type: "earrings",
    description: "Boucles d'oreilles Fleur de Lotus en pâte polymère, pièce unique faite main. Design élégant inspiré de la nature. Puce en acier inoxydable.",
    priceInCents: null,
    currency: null,
    ...
    gemType: "none",
    collection: "Fleurs",
    tags: JSON.stringify(["fleur", "lotus", "fait main", "pâte polymère"]),
    isTryOnEnabled: true,
    tryOnImageUrl: null,
  },
  // Collection Cœurs
  ...
  },
  {
    id: 5,
    brandId: 1,
    name: "Boucles d'oreilles cœur scintillant",
    type: "earrings",
    description: "Boucles d'oreilles cœur avec effet scintillant. Création unique faite main en argile polymère. Parfaites pour les occasions spéciales.",
    priceInCents: null,
    currency: null,
    ...
    gemType: "none",
    collection: "Cœurs",
    tags: JSON.stringify(["cœur", "scintillant", "paillettes", "fait main"]),
    isTryOnEnabled: true,
    tryOnImageUrl: null,
  },
  {
  ...
  // Collection Géométrique
  {
    id: 7,
    brandId: 1,
    name: "Boucles d'oreilles géométriques noires",
    type: "earrings",
    description: "Boucles d'oreilles géométriques noires, design moderne et élégant. Artisanat local belge, pièce unique.",
    priceInCents: null,
    currency: null,
    ...
    gemType: "none",
    collection: "Géométrique",
    tags: JSON.stringify(["géométrique", "noir", "moderne", "artisanat local"]),
    isTryOnEnabled: true,
    tryOnImageUrl: null,
  },
  {
  ...
  },
  {
    ...
    type: "earrings",
    description: "Boucles d'oreilles en résine couleur orange vibrante. Pièce unique faite main dans l'atelier Moni'attitude.",
    priceInCents: null,
    currency: null,
    imageUrl: "https://images.unsplash.com/photo-1596944924616-7b38e7cfac36?w=400",
    productUrl: "https://moniattitude.com/boutique-de-bijoux-artisanaux",
    metalType: "resin",
    gemType: "none",
    collection: "Résine",
    tags: JSON.stringify(["résine", "orange", "fait main"]),
    isTryOnEnabled: true,
    tryOnImageUrl: null,
  },
  // Collection Feuilles
  ...
  },
  {
    ...
    priceInCents: null,
    currency: null,
    imageUrl: "https://images.unsplash.com/photo-1629224316810-9d8805b95e76?w=400",
    productUrl: "https://moniattitude.com/boutique-de-bijoux-artisanaux",
    metalType: "polymer",
    gemType: "none",
    collection: "Feuilles",
