...
export const it: TranslationKeys = {
  ...
  profile: {
    ...
    preferences: {
      ...
      savedMessage: "Le tue preferenze sono state salvate con successo.",
      saveError: "Impossibile salvare le tue preferenze.",
      metals: "Metalli preferiti",
      metalsDescription: "Seleziona i metalli che preferisci",
      stones: "Pietre preferite",
      stonesDescription: "Seleziona le pietre che ti piacciono",
      styles: "Stili preferiti",
      stylesDescription: "Scegli i tuoi stili di gioielli preferiti",
      occasions: "Occasioni",
      occasionsDescription: "Per quali occasioni indossi gioielli?",
      budget: "Budget",
      budgetDescription: "Qual è il tuo budget abituale per i gioielli?",
      skinTone: "Tono della pelle",
      skinToneDescription: "Per raccomandazioni di colori personalizzate",
      saveButton: "Salva le mie preferenze",
    },
    historyTab: {
      title: "Cronologia prove",
      empty: "Nessuna prova",
      emptyDescription: "Le tue prove appariranno qui dopo aver provato i gioielli.",
      clearHistory: "Cancella cronologia",
      clearConfirm: "Vuoi davvero cancellare tutta la cronologia?",
      duration: "Durata",
      liked: "Piaciuto",
      shared: "Condiviso",
    },
    wishlist: {
      ...
      empty: "Lista vuota",
      emptyDescription: "Aggiungi gioielli alla tua lista dei desideri per trovarli facilmente.",
      addItem: "Aggiungi gioiello",
      priority: "Priorità",
      notes: "Note",
      notesPlaceholder: "Aggiungi note...",
      visitBrand: "Visita marchio",
      removeConfirm: "Rimuovere dalla lista dei desideri?",
    },
  },
  ...
  settings: {
    ...
    subscriptionLabel: "IL MIO ABBONAMENTO",
    activeBadge: "ATTIVO",
    tryonsUsed: "prova/e usata/e",
    tryonsRemaining: "rimanente/i",
    upgradeButton: "✶ PASSA A JEWELRY O PREMIUM",
    upgradePremium: "✶ PASSA A PREMIUM",
    seeAllPlans: "VEDI TUTTI I PIANI",
    seeAllPlansDesc: "Confronta Jewelry, Premium mensile e annuale",
    restorePurchases: "Ripristina acquisti",
    syncSubscription: "Sincronizza abbonamento",
    subscribeButton: "Abbonati",
    languageLabel: "LINGUA",
    wardrobeLabel: "IL MIO GUARDAROBA",
    wardrobeHistory: "Cronologia prove",
    wardrobeHistorySub: "Le tue ultime 20 prove IA",
    wardrobePhotos: "Le Mie Foto",
    wardrobePhotosSub: "Gestisci le tue foto per le prove",
    preferencesLabel: "PREFERENZE",
    haptics: "Feedback aptico",
    hapticsSub: "Vibrazioni tattili",
    notificationsSub: "Ricevi avvisi",
    legalLabel: "LEGALE",
    ...
    faq: "Aiuto e FAQ",
    rate: "Valuta l'App",
    dangerLabel: "ZONA PERICOLO",
    deleteSubtitle: "Eliminazione irreversibile di tutti i tuoi dati",
    deleteAlertTitle: "Elimina il mio account",
    deleteAlertMsg: "Questa azione è irreversibile. Tutti i tuoi dati saranno eliminati definitivamente.",
    deleteCancel: "Annulla",
    deleteConfirm: "Elimina definitivamente",
    deleteFinalTitle: "Conferma finale",
    deleteFinalMsg: "Sei assolutamente sicuro? Questa azione non può essere annullata.",
    deleteFinalConfirm: "Sì, elimina",
    appVersion: "Versione",
  ...
  demoGallery: {
    title: "Galleria Demo",
    intro: "Scopri come i nostri gioielli si adattano a tutti i tipi di corpo e tonalità di pelle.",
    categories: {
      all: "Tutti",
      hands: "Mani",
      ears: "Orecchie",
    ...
    skinTones: {
      light: "Tono di pelle chiaro",
      medium: "Tono di pelle medio",
      dark: "Tono di pelle scuro",
    },
    inclusivityTitle: "Per tutti",
    inclusivityMessage: "L'Écrin Virtuel è progettato per tutte le persone, indipendentemente dal genere, dal tono della pelle o dal tipo di corpo. I gioielli sono universali.",
  },
  tabs: {
    home: "Home",
    tryOn: "Prova",
